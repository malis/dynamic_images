...
You need to add <tt>cairo</tt> and <tt>pango</tt> gems to your Gemfile of environment.rb file.
...
Do not forgot to add mime types for user image formats to your environment file.
